...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = 'cryptobtc.xin - 专注于加密资产的ai百科全书';

  return {
    metadataBase: new URL(process.env.TARGET || ''),
    title,
    description:
      'cryptobtc是专注于加密资产的ai百科全书，提供全面、专业的区块链和数字货币知识，包括比特币、以太坊、狗狗币等主流加密货币的介绍、解析、投资指南和市场分析。提供专业的AI智能答疑，提供专业、准确、及时、全面的加密资产信息，实时解答用户的相关问题，为用户的加密资产相关决策提供科学、客观的参考依据。',
    keywords:
      'crypto,cryptobtc,cryptoai,ai,加密资产,区块链,数字货币,百科全书,加密,百科,wiki,crypto,bitcoin,btc,eth,doge,coin,hongkong,香港,澳门',
    icons: {
